...
const SidebarContent: React.FC<SidebarContentProps> = ({ onClose }) => {
    ...
    const customHeader = (title: string) => {
        return (
            <div translate="no" className="panel-header-wrapper">
                <span>{title}</span>
            </div>
        );
    };
    ...
    return (
        <div translate="no" className="parish-sidebar shadow-2 p-3 border-round">
            <div translate="no" className="sidebar-header">
            ...
            <Panel
                ...
                toggleable
            >
                <div translate="no" className="flex-column gap-3">
                    <div translate="no" className="surface-100">
            ...
            <Panel
                ...
                toggleable
            >
                <div translate="no" className="flex-column align-items-center">
